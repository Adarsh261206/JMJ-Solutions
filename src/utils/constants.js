...
export const COMMERCIAL_CLIENTS = [
  {
    name: 'Lechler India Pvt Ltd',
    location: 'Wagle Estate, Thane',
    image: '/images/clients/commercial-1.jpg',
    mapsQuery: 'Lechler+India+Pvt+Ltd+Wagle+Estate+Thane',
    coords: { lat: 19.1815, lng: 72.9754 },
  },
  {
    name: 'Gilly Professional Kitchen',
    location: 'Bhoomi World, Bhivandi',
    image: '/images/clients/commercial-2.jpg',
    mapsQuery: 'Bhoomi+World+Bhivandi+Maharashtra',
    coords: { lat: 19.2959, lng: 73.0630 },
  },
  {
    name: 'Semantic India Pvt Ltd',
    location: 'Mahape, Navi Mumbai',
    image: '/images/clients/commercial-3.jpg',
    mapsQuery: 'Mahape+Navi+Mumbai+Maharashtra',
    coords: { lat: 19.1121, lng: 73.0107 },
  },
  {
    name: 'Active Industries',
    location: 'Upwan, Thane',
    image: '/images/clients/commercial-4.jpg',
    mapsQuery: 'Upwan+Lake+Thane+Maharashtra',
    coords: { lat: 19.2183, lng: 72.9781 },
  },
  {
    name: 'Techvisio Design',
    location: 'Centrum Business Square, Wagle Estate, Thane',
    image: '/images/clients/commercial-5.jpg',
    mapsQuery: 'Centrum+Business+Square+Wagle+Estate+Thane',
    coords: { lat: 19.1852, lng: 72.9741 },
  },
  {
    name: 'Centrum Business Square B Wing',
    location: 'Wagle Estate, Thane',
    image: '/images/clients/commercial-6.jpg',
    mapsQuery: 'Centrum+Business+Square+B+Wing+Wagle+Estate+Thane',
    coords: { lat: 19.1852, lng: 72.9741 },
  },
  {
    name: 'From Packaging Systems India Pvt Ltd',
    location: 'Panvel, Aurangabad, Khanapur',
    image: '/images/clients/commercial-7.jpg',
    mapsQuery: 'Panvel+Navi+Mumbai+Maharashtra',
    coords: { lat: 18.9894, lng: 73.1175 },
  },
  {
    name: 'Indusprint Logistics Private Ltd',
    location: 'Ulhasnagar',
    image: '/images/clients/commercial-8.jpg',
    mapsQuery: 'Ulhasnagar+Thane+Maharashtra',
    coords: { lat: 19.2183, lng: 73.1558 },
  },
];
...
export const RESIDENTIAL_CLIENTS = [
  {
    ...
    image: '/images/clients/residential-1.jpg',
    mapsQuery: 'Runwal+Garden+City+Balkum+Thane',
    coords: { lat: 19.1876, lng: 72.9954 },
  },
  {
    name: 'Vedant CHSL',
    location: 'Vartak Nagar, Thane',
    image: '/images/clients/residential-2.jpg',
    mapsQuery: 'Vartak+Nagar+Thane+Maharashtra',
    coords: { lat: 19.2094, lng: 72.9814 },
  },
  {
    name: 'Ashar Sapphire',
    location: 'Dhokali, Thane',
    image: '/images/clients/residential-3.jpg',
    mapsQuery: 'Ashar+Sapphire+Dhokali+Thane',
    coords: { lat: 19.2235, lng: 72.9755 },
  },
  {
    name: 'Lodha Magestica & Casa Royal',
    location: 'Balkum, Thane',
    image: '/images/clients/residential-4.jpg',
    mapsQuery: 'Lodha+Magestica+Balkum+Thane',
    coords: { lat: 19.1876, lng: 72.9954 },
  },
  {
    name: 'Wadhwa Platina',
    location: 'Kolshet Road, Thane',
    image: '/images/clients/residential-5.jpg',
    mapsQuery: 'Wadhwa+Platina+Kolshet+Road+Thane',
    coords: { lat: 19.2401, lng: 72.9760 },
  },
  {
    name: 'Neelkanth Green CHSL',
    location: 'Manpada, Thane',
    image: '/images/clients/residential-6.jpg',
    mapsQuery: 'Manpada+Thane+Maharashtra',
    coords: { lat: 19.2316, lng: 73.0082 },
  },
  {
    name: 'Godrej Emerald',
    location: 'Owala, GB Road, Thane',
    image: '/images/clients/residential-7.jpg',
    mapsQuery: 'Godrej+Emerald+Owala+Thane',
    coords: { lat: 19.2502, lng: 72.9817 },
  },
  {
    name: 'Riverview Society, Lodha Splendora',
    location: 'Owala, GB Road, Thane',
    image: '/images/clients/residential-8.jpg',
    mapsQuery: 'Lodha+Splendora+Owala+Thane',
    coords: { lat: 19.2510, lng: 72.9820 },
  },
  {
    name: 'Rain Art CHSL',
    location: 'Vartak Nagar, Thane',
    image: '/images/clients/residential-9.jpg',
    mapsQuery: 'Vartak+Nagar+Thane+Maharashtra',
    coords: { lat: 19.2094, lng: 72.9814 },
  },
];
